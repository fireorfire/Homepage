try {
    ...
    (function (window, $, undefined) {
        ...
        try {
            if(window.mpvStorageMutex){

                return;
            }
            window.mpvStorageMutex = true;
                      ...
                      try {
                          ...
                          if (window.postMessage) {
                              ...
                              root.loadScript(root.baseURL + "/misc/postmessage.min.js", "postMessage", $, function () {
                                  try {
                                      var ifrParams = {
                                          "random": window.mpvInterface && mpvInterface.getParam("r") || 10015,
                 ...
                 "getBaseURL": function (cb) {
                     ...
                     try {
                         ...
                         if (window.mpvInterface) {
                             ...
                             return cb(mpvInterface.getParam("storageURL"));
                         }
