try{
    ...
    var lastdata,mngr = {
        ...
        "monitorDataTimeout" : null,
        "monitorDataInterval" : 2000,
        "param": null,
        ...
        "setLastData" : function(data){
            ...
            try {
                lastdata = data;
                clearTimeout(this.monitorDataTimeout);
                this.monitorData();
            }
        ...
        "monitorData" : function() {
            ...
            try{
                var that = this;
                var freshData = localStorage.getItem("mpvJSON") || "{}";
                if (freshData !== lastdata) {

                    lastdata = freshData;
                    this.sendNewData(lastdata);
                }

                
               this.monitorDataTimeout = setTimeout(function () {
        ...
        "sendNewData" : function(){
            ...
            try{
                this.postMessage("onDataSet_" + lastdata);
            }
